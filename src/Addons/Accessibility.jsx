...
const Accessibility = () => {
  ...
  const {theme,setTheme,lang,setLang,currency,setCurrency} = useContext(SettingsContext)
  ...
  return (
    ...
    >
      <button
        className="btn border-2 border bg-dark text-light border-2 rounded-4 btn-light position-relative p-1 d-flex justify-content-center align-items-center"
        onClick={() => {
      ...
      <div
        className={`${
          show ? "" : "d-none"
        } position-absolute bottom-0 bg-dark left-0 rounded-4 border border-2`}
        style={{ width: "25em", height: "15em",zIndex:"-1" }}
      >
        <form onSubmit={(e)=>{e.preventDefault()}} className="p-4 d-flex flex-column gap-3 justify-content-evenly h-100 list_of_inputs">
            ...
            <div className="d-flex flex-row gap-3 align-items-center justify-content-around">
                ...
                <select defaultValue={lang} name="lang" id="lang" onChange={(e)=>{setLang(e.target.value)}}>

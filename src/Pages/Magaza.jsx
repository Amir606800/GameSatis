...
const Magaza = () => {
  return (
    <div className="container-fluid ">
        <Path />
        <div className="text-center mb-5"><img src="https://www.gamesatis.com/assets/gamesatis/gmslogo-13-5aaf6824ac956e8a20cec415a8c0ffcf8d5ca389a9ca005acf344fc9e6fab2d4.svg" width={300} alt="Logo" /> </div>
        <div className="text-center mt-4"><img src="https://www.gamesatis.com/assets/store/stores-slogan-d8e0dc8a612dfc7d4ebf0795360d6ed97a1a90d20628ab394c7f609f1ffe73b5.png" width={1000} alt="Logo" /> </div>
    <div className=" bg-dark p-4 rounded-2 mb-5 mt-4">
      <div id="about-stores" className="">
        ...
        <p>
          Tüm oyuna dair içeriklerinizi ilana ekleyerek satışını yapabileceğiniz
          ve anında emeğinizi nakite çevirebileceğiniz bir sistemdir. Oyun
          hesapları, oyun paraları, oyun keyleri, skin, item, boost ve bir çok
          ürünü uygun fiyatlara satın alabilir ya da bu ürünlerden sizler de
          satabilirsiniz.
        </p>
        <p>
          <img
        ...
        <p>
          ...
          League of Legends Hesap, Steam Random Key ve buna benzer birçok ürünü
          bulabileceğiniz oyuncu pazarı tüm kullanıcılar için en ucuz fiyatlar
          ve teslimat sonrası tarafınızca onaylanana kadar GameSatış tarafından
          bakiye güvencesi ile hizmetinize sunulmuştur.
        </p>
        ...
        <p>
          ...
          güvenilir mağazalar ile alıcılara ucuza hızlı alışveriş imkanı sunar.
          Oyuncu pazarı satışlarında GameSatış yalnızca aracılık yapmaktadır.
          Ödemenin güvenli bir şekilde alıcıdan satıcıya aktarılmasını sağlar.
          Başarılı satışların ardından garanti vermemektedir. Alıcı alışverişi
          tamamladıktan sonra tüm sorumluluk kendisine aittir.
        </p>
        <hr />
        ...
        <section className="m-0 p-0">
          ...
          >
            {[1,2,3,4,5,6].map((item,index)=>(
                <div key={index} className="col-6 col-md-4 col-lg-3 col-xl-2 product-card t">
                  ...
                  >
                    <div className="card-img mb-4 position-relative text-center">
                        ...
                        />
                          ...
                          <img src="https://www.gamesatis.com/assets/store/ornek-ilan-resmi-15b9ac749bc4979a4fade6a1605e69a0ba3f5024b74e0e47df95a0d871831bbd.jpg" className="w-100" height={140} alt="" />
                      <div
                      ...
                      >
                        <div className="d-flex flex-row w-100 py-2"  style={{fontSize:"12px"}} >Örnek bir item</div> 
                      </div>
        ...
        <p>
          ...
          kullanıcının güvenli alışveriş yapması adına getirilen bir sistemdir.
        </p>
        <p>
          ...
          Kendinizin, sitede kayıtlı olmuş olduğunuz isim ve TC kimlik numarası
          olan kimliğiniz ve üzerinde gamesatis.com - tarih (gün/ay/yıl) yazan
          bir kağıt bulunmalıdır. Tüm bilgiler okunaklı olmadığı takdirde ve
          gönderdiğiniz evrakta eksik olması durumunda&nbsp;mağazanız
          onaylanmayacaktır.
        </p>
        <p>
          <img
        ...
        <p>
          ...
          butonuna tıklayıp gerçekleştirmeniz gerekmektedir. Ürün teslimatı için
          size tanınan süre belirttiğiniz teslimat saatidir.
        </p>
        <table
          align="center"
          border={0}
        ...
        <p>
          ...
          satış ücreti site bakiyesi olarak hesabınıza eklenecektir. Alıcınızın
          ürünü onaylaması için ayrılan süre ise{" "}
          <u>
        ...
        <p>
          ...
          bir adet başarısız satış puanı eklenecektir.. Bunun dışında teslimatı
          yapmadan onay isteyen satıcıların uyarı yapılmadan mağazası kapatılır.
          Başka bir platform&nbsp;
        ...
        <p>
          ...
          <strong>Onaysız Mağaza&nbsp;</strong>olarak ikiye ayrılmıştır. Onaylı
          ve onaysız mağazaların detaylarını aşağıda bulabilirsiniz.
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>Onaylanmış Mağaza;</strong> sadece 10&nbsp;adet ilan ekler.
            (Ekstra ilan satın alabilir.)
          </li>
        </ul>
        <p>
        ...
        <ul>
          ...
          <li>
            Öne çıkarılan ilanlar ilk sayfa dışındaki diğer sayfalarda ve arama
            sonuçlarında vitrin ilanı olarak gözükmez.
          </li>
          <li>
            Öne çıkarılan bir ilan boost süresi dolmadan satılırsa ücret iadesi
            yapılmaz.
          </li>
        </ul>
          ...
          <table className="table">
            <tbody>
              <tr>
                ...
                <td>
                  <strong>- Yeni Mağaza:&nbsp;</strong>Yeni oluşturulmuş, henüz
                  10 başarılı satış işlemi gerçekleştirmemiş mağazadır.
                </td>
              </tr>
              <tr>
                <td className="text-center">
              ...
              <tr>
                ...
                <td>
                  <strong>- Silver Mağaza:&nbsp;</strong>%80 Başarı oranı,en az
                  250 başarılı satışı ve 5.000TL üzeri toplamda satış yapmış
                  olması gerekir.
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <strong>- Master Mağaza:&nbsp;</strong>%80 Başarı oranı,en az
                  5000 başarılı satışı ve 100.000 TL üzeri toplamda satış yapmış
                  olması gerekir.
                </td>
              </tr>
            </tbody>
        ...
        <ul className="ls-disc">
          ...
          <li>
            Alıcıya verilen 48 saat kontrol süresi alıcı tarafından sonuna kadar
            kullanılabilir. Bu konu hakkında satıcı mağazaların alıcılara
            bildirim göndermesi yasaktır.
          </li>
          <li>
          ...
          <li>
            ...
            hesap/ürün satışı yasaktır. Tespiti halinde mağazanız kalıcı olarak
            kısıtlanır ve geri dönüşü mümkün olmamaktadır.
          </li>
          <li>
          ...
          <li>
            ...
            hakaret, tehdit vb.) Tespiti halinde mağazanız kapatılır ve hiç bir
            ürün için mesaj gönderemezsiniz.
          </li>
          <li>
            Başarılı satış oranınız %50 nin altına düşerse hesabınız incelemeye
            alınır ve gerekli görülürse mağazanız kapatılır.
          </li>
          <li>
          ...
          <li>
            ...
            bir platform&nbsp;( Whatsapp, Discord, Skype vb.) üzerinden yapılan
            konuşmalar dikkate alınmaz. Tespiti halinde mağazanız kapatılır.
          </li>
          <li>
        ...
        <p>
          <span style={{ fontSize: 16 }}>
            Bu güncellemeler ile sizlere daha güzel bir satış ortamı oluşturmak
            için yapılmıştır. İyi satışlar dileriz.
          </span>
        </p>
      </div>
    </div>
